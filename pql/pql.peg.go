	...
	_rules = [...]func() bool{
		...
		func() bool {
			...
			l224:
				...
				add(rulesinglequotedstring, position223)
			}
			return true
		},
		...
		func() bool {
			...
			l308:
				...
				position++
				add(ruletimestampbasicfmt, position307)
			}
			return true
		l306:
		...
		func() bool {
			...
			l312:
				add(ruletimestampfmt, position311)
			}
			return true
		l310:
