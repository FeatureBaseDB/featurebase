	...
	_rules = [...]func() bool{
		...
		func() bool {
			...
			l278:
				...
				position++
				add(ruletimestampbasicfmt, position277)
			}
			return true
		l276:
		...
		func() bool {
			...
			l282:
				add(ruletimestampfmt, position281)
			}
			return true
		l280:
