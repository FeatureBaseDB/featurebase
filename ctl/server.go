...
func BuildServerFlags(cmd *cobra.Command, srv *server.Command) {
	...
	flags.StringVarP(&srv.Config.GossipPort, "gossip-port", "", "14000", "Port to which pilosa should bind for internal state sharing.")
	flags.StringVarP(&srv.Config.GossipSeed, "gossip-seed", "", "127.0.0.1:14000", "Host with which to seed the gossip membership.")
