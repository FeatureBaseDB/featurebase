...
BSI (bit-sliced index) is the storage method Pilosa utilizes to represent multi-bit integers in a bitmap index. Integers are stored as n-bit, range-encoded
