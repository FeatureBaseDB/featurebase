...
var (
	...
	ErrBSIGroupValueTooLow      = errors.New("imported value too low for configured field range")
	ErrBSIGroupValueTooHigh     = errors.New("imported value too high for configured field range")
