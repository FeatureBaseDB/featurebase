...
func TestViewByTimeUnitAlloc(t *testing.T) {
	ts := time.Date(2000, time.January, 2, 3, 4, 5, 6, time.UTC)

	t.Run("Y", func(t *testing.T) {
		if s := viewByTimeUnitAlloc("F", ts, 'Y'); s != "F_2000" {
			t.Fatalf("unexpected name: %s", s)
		}
	})
	t.Run("M", func(t *testing.T) {
		if s := viewByTimeUnitAlloc("F", ts, 'M'); s != "F_200001" {
			t.Fatalf("unexpected name: %s", s)
		}
	})
	t.Run("D", func(t *testing.T) {
		if s := viewByTimeUnitAlloc("F", ts, 'D'); s != "F_20000102" {
			t.Fatalf("unexpected name: %s", s)
		}
	})
	t.Run("H", func(t *testing.T) {
		if s := viewByTimeUnitAlloc("F", ts, 'H'); s != "F_2000010203" {
			t.Fatalf("unexpected name: %s", s)
		}
	})
}
...
func TestViewsByTime(t *testing.T) {
	...
	t.Run("YMDH", func(t *testing.T) {
		a := viewsByTime("F", ts, mustParseTimeQuantum("YMDH"), viewByTimeUnitAlloc)
	...
	t.Run("D", func(t *testing.T) {
		a := viewsByTime("F", ts, mustParseTimeQuantum("D"), viewByTimeUnitAlloc)
...
func TestViewsByTimeRange(t *testing.T) {
	t.Run("Y", func(t *testing.T) {
		a := viewsByTimeRange("F", mustParseTime("2000-01-01 00:00"), mustParseTime("2002-01-01 00:00"), mustParseTimeQuantum("Y"), viewByTimeUnitAlloc)
		if !reflect.DeepEqual(a, []string{"F_2000", "F_2001"}) {
			t.Fatalf("unexpected fields: %#v", a)
		}
	})
	t.Run("YM", func(t *testing.T) {
		a := viewsByTimeRange("F", mustParseTime("2000-11-01 00:00"), mustParseTime("2003-03-01 00:00"), mustParseTimeQuantum("YM"), viewByTimeUnitAlloc)
		if !reflect.DeepEqual(a, []string{"F_200011", "F_200012", "F_2001", "F_2002", "F_200301", "F_200302"}) {
			t.Fatalf("unexpected fields: %#v", a)
		}
	})
	t.Run("YM31up", func(t *testing.T) {
		a := viewsByTimeRange("F", mustParseTime("2001-10-31 00:00"), mustParseTime("2003-04-01 00:00"), mustParseTimeQuantum("YM"), viewByTimeUnitAlloc)
		if !reflect.DeepEqual(a, []string{"F_200110", "F_200111", "F_200112", "F_2002", "F_200301", "F_200302", "F_200303"}) {
			t.Fatalf("unexpected fields: %#v", a)
		}
	})
	t.Run("YM31mid", func(t *testing.T) {
		a := viewsByTimeRange("F", mustParseTime("1999-12-31 00:00"), mustParseTime("2000-04-01 00:00"), mustParseTimeQuantum("YM"), viewByTimeUnitAlloc)
		if !reflect.DeepEqual(a, []string{"F_199912", "F_200001", "F_200002", "F_200003"}) {
			t.Fatalf("unexpected fields: %#v", a)
		}
	})
	t.Run("YM31down", func(t *testing.T) {
		a := viewsByTimeRange("F", mustParseTime("2000-01-31 00:00"), mustParseTime("2001-04-01 00:00"), mustParseTimeQuantum("YM"), viewByTimeUnitAlloc)
		if !reflect.DeepEqual(a, []string{"F_2000", "F_200101", "F_200102", "F_200103"}) {
			t.Fatalf("unexpected fields: %#v", a)
		}
	})
	t.Run("YMD", func(t *testing.T) {
		a := viewsByTimeRange("F", mustParseTime("2000-11-28 00:00"), mustParseTime("2003-03-02 00:00"), mustParseTimeQuantum("YMD"), viewByTimeUnitAlloc)
		if !reflect.DeepEqual(a, []string{"F_20001128", "F_20001129", "F_20001130", "F_200012", "F_2001", "F_2002", "F_200301", "F_200302", "F_20030301"}) {
			t.Fatalf("unexpected fields: %#v", a)
		}
	})
	t.Run("YMDH", func(t *testing.T) {
		a := viewsByTimeRange("F", mustParseTime("2000-11-28 22:00"), mustParseTime("2002-03-01 03:00"), mustParseTimeQuantum("YMDH"), viewByTimeUnitAlloc)
	...
	t.Run("M", func(t *testing.T) {
		a := viewsByTimeRange("F", mustParseTime("2000-01-01 00:00"), mustParseTime("2000-03-01 00:00"), mustParseTimeQuantum("M"), viewByTimeUnitAlloc)
		if !reflect.DeepEqual(a, []string{"F_200001", "F_200002"}) {
			t.Fatalf("unexpected fields: %#v", a)
		}
	})
	t.Run("MD", func(t *testing.T) {
		a := viewsByTimeRange("F", mustParseTime("2000-11-29 00:00"), mustParseTime("2002-02-03 00:00"), mustParseTimeQuantum("MD"), viewByTimeUnitAlloc)
	...
	t.Run("MDH", func(t *testing.T) {
		a := viewsByTimeRange("F", mustParseTime("2000-11-29 22:00"), mustParseTime("2002-03-02 03:00"), mustParseTimeQuantum("MDH"), viewByTimeUnitAlloc)
	...
	t.Run("D", func(t *testing.T) {
		a := viewsByTimeRange("F", mustParseTime("2000-01-01 00:00"), mustParseTime("2000-01-04 00:00"), mustParseTimeQuantum("D"), viewByTimeUnitAlloc)
		if !reflect.DeepEqual(a, []string{"F_20000101", "F_20000102", "F_20000103"}) {
			t.Fatalf("unexpected fields: %#v", a)
		}
	})
	t.Run("DH", func(t *testing.T) {
		a := viewsByTimeRange("F", mustParseTime("2000-01-01 22:00"), mustParseTime("2000-03-01 02:00"), mustParseTimeQuantum("DH"), viewByTimeUnitAlloc)
	...
	t.Run("H", func(t *testing.T) {
		a := viewsByTimeRange("F", mustParseTime("2000-01-01 00:00"), mustParseTime("2000-01-01 02:00"), mustParseTimeQuantum("H"), viewByTimeUnitAlloc)
