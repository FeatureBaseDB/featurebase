...
type NodeStatus struct {
	...
	HostList []string `protobuf:"bytes,4,rep,name=HostList" json:"HostList,omitempty"`
}
...
func (m *NodeStatus) GetHostList() []string {
	if m != nil {
		return m.HostList
	}
	return nil
...
type ClusterStatus struct {
	...
	HostList []string `protobuf:"bytes,2,rep,name=HostList" json:"HostList,omitempty"`
}
...
func (m *ClusterStatus) GetHostList() []string {
	if m != nil {
		return m.HostList
	}
	return nil
...
func (m *ResizeInstruction) GetHost() string {
	if m != nil {
		return m.Host
	}
	return ""
...
func (m *ResizeInstruction) GetCoordinator() string {
	if m != nil {
...
func (m *ResizeSource) GetHost() string {
	if m != nil {
		return m.Host
	}
	return ""
...
func (m *ResizeInstructionComplete) GetHost() string {
	if m != nil {
		return m.Host
	}
	return ""
...
type Topology struct {
	HostList []string `protobuf:"bytes,1,rep,name=HostList" json:"HostList,omitempty"`
}
...
func (m *Topology) GetHostList() []string {
	if m != nil {
		return m.HostList
	}
	return nil
...
func (m *ResizeInstruction) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.Coordinator) > 0 {
		dAtA[i] = 0x1a
		i++
		i = encodeVarintPrivate(dAtA, i, uint64(len(m.Coordinator)))
		i += copy(dAtA[i:], m.Coordinator)
	}
	if len(m.Sources) > 0 {
...
func (m *NodeStatus) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			m.HostList = append(m.HostList, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipPrivate(dAtA[iNdEx:])
...
var fileDescriptorPrivate = []byte{
	...
	,
}
