...
func (*URI) Descriptor() ([]byte, []int) { return fileDescriptorPrivate, []int{19} }
...
type NodeStatus struct {
	...
	URISet  []*URI   `protobuf:"bytes,4,rep,name=URISet" json:"URISet,omitempty"`
}
...
func (m *NodeStatus) GetURISet() []*URI {
	if m != nil {
		return m.URISet
	}
	return nil
