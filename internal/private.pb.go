...
/*
	...
	It has these top-level messages:
		...
		CreateFrameMessage
		DeleteFrameMessage
		CreateBSIGroupMessage
		DeleteBSIGroupMessage
		Frame
		Schema
		Index
		URI
...
type FrameMeta struct {
	...
	BSIGroups   []*BSIGroup `protobuf:"bytes,7,rep,name=BSIGroups" json:"BSIGroups,omitempty"`
}
...
func (m *FrameMeta) GetBSIGroups() []*BSIGroup {
	if m != nil {
		return m.BSIGroups
	}
	return nil
...
type CreateBSIGroupMessage struct {
	Index    string    `protobuf:"bytes,1,opt,name=Index,proto3" json:"Index,omitempty"`
	Frame    string    `protobuf:"bytes,2,opt,name=Frame,proto3" json:"Frame,omitempty"`
	BSIGroup *BSIGroup `protobuf:"bytes,3,opt,name=BSIGroup" json:"BSIGroup,omitempty"`
}

func (m *CreateBSIGroupMessage) Reset()                    { *m = CreateBSIGroupMessage{} }
func (m *CreateBSIGroupMessage) String() string            { return proto.CompactTextString(m) }
func (*CreateBSIGroupMessage) ProtoMessage()               {}
func (*CreateBSIGroupMessage) Descriptor() ([]byte, []int) { return fileDescriptorPrivate, []int{12} }

func (m *CreateBSIGroupMessage) GetIndex() string {
	if m != nil {
		return m.Index
	}
	return ""
...
func (m *CreateBSIGroupMessage) GetFrame() string {
	if m != nil {
		return m.Frame
	}
	return ""
...
func (m *CreateBSIGroupMessage) GetBSIGroup() *BSIGroup {
	if m != nil {
		return m.BSIGroup
	}
	return nil
...
type DeleteBSIGroupMessage struct {
	Index    string `protobuf:"bytes,1,opt,name=Index,proto3" json:"Index,omitempty"`
	Frame    string `protobuf:"bytes,2,opt,name=Frame,proto3" json:"Frame,omitempty"`
	BSIGroup string `protobuf:"bytes,3,opt,name=BSIGroup,proto3" json:"BSIGroup,omitempty"`
}

func (m *DeleteBSIGroupMessage) Reset()                    { *m = DeleteBSIGroupMessage{} }
func (m *DeleteBSIGroupMessage) String() string            { return proto.CompactTextString(m) }
func (*DeleteBSIGroupMessage) ProtoMessage()               {}
func (*DeleteBSIGroupMessage) Descriptor() ([]byte, []int) { return fileDescriptorPrivate, []int{13} }

func (m *DeleteBSIGroupMessage) GetIndex() string {
	if m != nil {
		return m.Index
	}
	return ""
...
func (m *DeleteBSIGroupMessage) GetFrame() string {
	if m != nil {
		return m.Frame
	}
	return ""
...
func (m *DeleteBSIGroupMessage) GetBSIGroup() string {
	if m != nil {
		return m.BSIGroup
	}
	return ""
...
func init() {
	...
	proto.RegisterType((*CreateBSIGroupMessage)(nil), "internal.CreateBSIGroupMessage")
	proto.RegisterType((*DeleteBSIGroupMessage)(nil), "internal.DeleteBSIGroupMessage")
...
func (m *FrameMeta) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.BSIGroups) > 0 {
		for _, msg := range m.BSIGroups {
			dAtA[i] = 0x3a
			i++
...
func (m *CreateBSIGroupMessage) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *CreateBSIGroupMessage) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	...
	if m.BSIGroup != nil {
		dAtA[i] = 0x1a
		i++
		i = encodeVarintPrivate(dAtA, i, uint64(m.BSIGroup.Size()))
		n9, err := m.BSIGroup.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n9
...
func (m *DeleteBSIGroupMessage) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *DeleteBSIGroupMessage) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	...
	if len(m.BSIGroup) > 0 {
		dAtA[i] = 0x1a
		i++
		i = encodeVarintPrivate(dAtA, i, uint64(len(m.BSIGroup)))
		i += copy(dAtA[i:], m.BSIGroup)
	}
	return i, nil
}
...
func (m *CreateBSIGroupMessage) Size() (n int) {
	var l int
	_ = l
	l = len(m.Index)
	if l > 0 {
...
func (m *DeleteBSIGroupMessage) Size() (n int) {
	var l int
	_ = l
	l = len(m.Index)
	if l > 0 {
...
func (m *FrameMeta) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field BSIGroups", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.BSIGroups = append(m.BSIGroups, &BSIGroup{})
			if err := m.BSIGroups[len(m.BSIGroups)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *CreateBSIGroupMessage) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: CreateBSIGroupMessage: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: CreateBSIGroupMessage: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field BSIGroup", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.BSIGroup.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *DeleteBSIGroupMessage) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: DeleteBSIGroupMessage: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: DeleteBSIGroupMessage: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 3:
			...
			m.BSIGroup = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipPrivate(dAtA[iNdEx:])
...
var fileDescriptorPrivate = []byte{
	...
	,
}
