...
type SetCoordinatorMessage struct {
	Old *URI `protobuf:"bytes,1,opt,name=Old" json:"Old,omitempty"`
	New *URI `protobuf:"bytes,2,opt,name=New" json:"New,omitempty"`
}
...
func (m *SetCoordinatorMessage) GetNew() *URI {
	if m != nil {
		return m.New
	}
	return nil
